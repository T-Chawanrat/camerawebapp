...
// import QrFromImageButton from "./QrFromImageButton"; // หรือ path ให้ตรงกับที่วางไฟล์
...
//   // ป้องกัน callback ยิงซ้ำ (กัน input เด้ง)
...
//   const startScan = async () => {
//     onErrorChange(null);
//     hasScannedRef.current = false; // รีเซ็ตก่อนเริ่มสแกนทุกครั้ง
...
//         v,
//         (result: Result | undefined) => {
//           // กันเด้ง: ให้ทำงานแค่ครั้งแรกที่เจอ result เท่านั้น
